    ...
    <div class="max-w-7xl mx-auto">
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border-t-4 border-[#003366]">
            ...
            <div class="bg-gradient-to-r from-[#003366] to-blue-800 px-8 py-6 text-center relative">
                ...
                <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-20 h-1 bg-[#FFD700] rounded-full"></div>
            </div>

            {{-- Form Body --}}
            <div class="p-8">
                <form action="{{ route('operator.laporan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    @csrf
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 border-l-4 border-[#FFD700]">
                        ...
                        <div id="tersangka-fields" class="space-y-6">
                            <div class="tersangka-field bg-white rounded-lg p-6 border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300" id="tersangka-1">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        <label for="tersangka_nama_1" class="block text-sm font-medium text-gray-700 mb-2">
                                    ...
                                    <div>
                                        <label for="tersangka_no_ktp_1" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                    <div>
                                        <label for="tersangka_jenis_kelamin_1" class="block text-sm font-medium text-gray-700 mb-2">
                                            Jenis Kelamin <span class="text-red-500">*</span>
                                        </label>
                                        <select class="w-full px-4 py-3 border-2  rounded-lg focus:border-[#FFD700] focus:ring-2 focus:ring-[#FFD700]/20 transition-colors duration-200 @error('tersangka.*.jenis_kelamin') border-red-500 @enderror" 
                                                name="tersangka[0][jenis_kelamin]" 
                                                >
                                            <option value="">Pilih Jenis Kelamin</option>
                                            <option value="L" {{ old('tersangka.0.jenis_kelamin') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                            <option value="P" {{ old('tersangka.0.jenis_kelamin') == 'P' ? 'selected' : '' }}>Perempuan</option>
                                        </select>
                                    ...
                                    <div>
                                        <label for="tersangka_tanggal_lahir_1" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                                    <div class="lg:col-span-2">
                                        <label for="tersangka_alamat_1" class="block text-sm font-medium text-gray-700 mb-2">
                                            Alamat <span class="text-red-500">*</span>
                                        </label>
                                        <textarea class="w-full px-4 py-3 border-2  rounded-lg focus:border-[#FFD700] focus:ring-2 focus:ring-[#FFD700]/20 transition-colors duration-200 @error('tersangka.*.alamat') border-red-500 @enderror" 
                                                  name="tersangka[0][alamat]" 
                                                  rows="3" 
                                                  placeholder="Masukkan alamat lengkap tersangka"
                                                  >{{ old('tersangka.0.alamat') }}</textarea>
                                        @error('tersangka.0.alamat')
                                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div>
                                        <label for="tersangka_foto_ktp_1" class="block text-sm font-medium text-gray-700 mb-2">
                                            Foto KTP
                                        </label>
                                        <div class="relative">
                                            <input type="file" 
                                                   id="tersangka_foto_ktp_1"
                        ...
                        <div class="flex justify-end mt-6">
                            <button type="button" id="add-tersangka" class="inline-flex items-center px-6 py-3 bg-green-500 hover:bg-green-600 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    ...
                    {{-- Laporan TAT Section --}}
                    <div class="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl p-6 border-l-4 border-[#003366]">
                        <h5 class="text-xl font-semibold text-[#003366] mb-6 flex items-center">
                            <svg class="w-6 h-6 mr-3 text-[#FFD700]" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div>
                            ...
                            <textarea class="w-full px-4 py-3 border-2  rounded-lg focus:border-[#FFD700] focus:ring-2 focus:ring-[#FFD700]/20 transition-colors duration-200 @error('kronologis') border-red-500 @enderror" 
                                      id="kronologis" 
                                      name="kronologis" 
                                      rows="5" 
                                      placeholder="Jelaskan kronologis kejadian secara detail..."
                                      >{{ old('kronologis') }}</textarea>
                            @error('kronologis')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl p-6 border-l-4 border-[#FFD700]">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="surat_permohonan_tat" class="block text-sm font-medium text-gray-700 mb-2">
                                ...
                                <input type="file" 
                                       ...
                                       id="surat_permohonan_tat" 
                                       name="surat_permohonan_tat" 
                                       accept=".pdf,.doc,.docx" 
                                       >
                            ...
                            <div>
                                <label for="surat_perintah_penangkapan" class="block text-sm font-medium text-gray-700 mb-2">
                                    Surat Perintah Penangkapan
                                </label>
                                <input type="file" 
                                       ...
                                       id="surat_perintah_penangkapan" 
                                       name="surat_perintah_penangkapan" 
                                       accept=".pdf,.doc,.docx">
                            ...
                            <div>
                                <label for="surat_perintah_penyidikan" class="block text-sm font-medium text-gray-700 mb-2">
                                    Surat Perintah Penyidikan
                                </label>
                                <input type="file" 
                                       ...
                                       id="surat_perintah_penyidikan" 
                                       name="surat_perintah_penyidikan" 
                                       accept=".pdf,.doc,.docx">
                            ...
                            <div>
                                <label for="surat_uji_laboratorium" class="block text-sm font-medium text-gray-700 mb-2">
                                    Surat Uji Laboratorium
                                </label>
                                <input type="file" 
                                       ...
                                       id="surat_uji_laboratorium" 
                                       name="surat_uji_laboratorium" 
                                       accept=".pdf,.doc,.docx">
                            ...
                            <div>
                                <label for="berita_acara_pemeriksaan_tersangka" class="block text-sm font-medium text-gray-700 mb-2">
                                    Berita Acara Pemeriksaan Tersangka
                                </label>
                                <input type="file" 
                                       ...
                                       id="berita_acara_pemeriksaan_tersangka" 
                                       name="berita_acara_pemeriksaan_tersangka" 
                                       accept=".pdf,.doc,.docx">
                            ...
                            <div>
                                <label for="surat_persetujuan_tat" class="block text-sm font-medium text-gray-700 mb-2">
                                    Surat Persetujuan TAT
                                </label>
                                <input type="file" 
                                       ...
                                       id="surat_persetujuan_tat" 
                                       name="surat_persetujuan_tat" 
                                       accept=".pdf,.doc,.docx">
                            ...
                            <div>
                                <label for="surat_pernyataan_penyidik" class="block text-sm font-medium text-gray-700 mb-2">
                                    Surat Pernyataan Penyidik
                                </label>
                                <input type="file" 
                                       ...
                                       id="surat_pernyataan_penyidik" 
                                       name="surat_pernyataan_penyidik" 
                                       accept=".pdf,.doc,.docx">
                            ...
                            <div>
                                <label for="file_surat_penerimaan" class="block text-sm font-medium text-gray-700 mb-2">
                                    File Surat Penerimaan
                                </label>
                                <input type="file" 
                                       ...
                                       id="file_surat_penerimaan" 
                                       name="file_surat_penerimaan" 
                                       accept=".pdf,.doc,.docx">
                    ...
                    <div class="bg-gray-50 rounded-xl p-6">
                        <div class="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4">
                            <a href="#" class="inline-flex items-center px-6 py-3 bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div class="flex space-x-3">
                                <button type="reset" class="inline-flex items-center px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                    <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M4 2a1 1 0 011 1v2.101a7.002 7.002 0 0111.601 2.566 1 1 0 11-1.885.666A5.002 5.002 0 005.999 7H9a1 1 0 010 2H4a1 1 0 01-1-1V3a1 1 0 011-1zm.008 9.057a1 1 0 011.276.61A5.002 5.002 0 0014.001 13H11a1 1 0 110-2h5a1 1 0 011 1v5a1 1 0 11-2 0v-2.101a7.002 7.002 0 01-11.601-2.566 1 1 0 01.61-1.276z" clip-rule="evenodd"></path>
                                    </svg>
                                    Reset
                                </button>
                                <button type="submit" class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-[#003366] to-blue-800 hover:from-blue-800 hover:to-[#003366] text-white font-bold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                    <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('add-tersangka').addEventListener('click', function() {
        ...
        tersangkaField.classList.add('tersangka-field', 'bg-white', 'rounded-lg', 'p-6', 'border', 'border-gray-200', 'shadow-sm', 'hover:shadow-md', 'transition-all', 'duration-300');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('remove-tersangka') || e.target.closest('.remove-tersangka')) {
